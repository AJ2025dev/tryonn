        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8" style={{ fontFamily: "'Outfit', sans-serif" }}>
            {categories.slice(0, 4).map((cat: any) => (
              <span key={cat.id} className="text-xs tracking-[0.15em] uppercase text-stone-500 hover:text-stone-900 cursor-pointer transition-colors">
                {cat.name}
              </span>
            ))}
          </nav>
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-8 items-center min-h-[520px]">
              <div className="py-16 md:py-24">
                <p className="text-xs tracking-[0.25em] uppercase mb-4" style={{ fontFamily: "'Outfit', sans-serif", color: accent }}>
                  {banners.length > 0 ? banners[0].name : "New Collection"}
                </p>
                <h1 className="text-5xl md:text-7xl font-light text-stone-900 leading-[1.1] mb-6 tracking-tight">
                  Discover<br />
                  <span className="italic font-normal" style={{ color: accent }}>Timeless</span><br />
                  Style
                </h1>
                <p className="text-base text-stone-500 mb-8 max-w-md leading-relaxed" style={{ fontFamily: "'Outfit', sans-serif" }}>
                  {tagline}
                </p>
                <Link href="#products" className="inline-block px-8 py-3.5 text-xs tracking-[0.2em] uppercase text-white transition-all hover:opacity-90" style={{ fontFamily: "'Outfit', sans-serif", backgroundColor: accent }}>
                  Shop Now
                </Link>
              </div>
              <div className="hidden md:block relative h-[520px]">
                {banners.length > 0 ? (
                  <img src={banners[0].image_url} alt="" className="absolute inset-0 w-full h-full object-cover" />
                ) : (
                  <div className="absolute inset-0" style={{ background: `linear-gradient(135deg, ${accent}22, ${accent}44)` }} />
                )}
              </div>
            </div>
          </div>
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <div className="mt-3 overflow-hidden">
                            <p className="text-xs tracking-[0.2em] uppercase text-white/80 translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500" style={{ fontFamily: "'Outfit', sans-serif" }}>
                              Discover →
                            </p>
                          </div>
                        </div>
          ...
          <section className="py-16" style={{ backgroundColor: "#FDFCFA" }}>
            <div className="max-w-7xl mx-auto px-6">
              <div className="flex items-end justify-between mb-10">
                ...
                <span className="text-xs tracking-[0.15em] uppercase text-stone-400 hover:text-stone-700 cursor-pointer transition-colors hidden md:block" style={{ fontFamily: "'Outfit', sans-serif" }}>
                  View All →
                </span>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-0 overflow-hidden" style={{ backgroundColor: "#F0EBE3" }}>
              <div className="p-12 md:p-16 flex flex-col justify-center">
                ...
                <h2 className="text-3xl md:text-5xl font-light text-stone-900 leading-tight mb-6 tracking-tight">
                  Effortless<br /><span className="italic">Elegance</span>
                </h2>
                <p className="text-sm text-stone-500 mb-8 max-w-sm leading-relaxed" style={{ fontFamily: "'Outfit', sans-serif" }}>
                  Curated pieces that transition seamlessly from day to evening. Timeless designs crafted with care.
                </p>
                <div>
                  <Link href="#products" className="inline-block px-8 py-3 text-xs tracking-[0.2em] uppercase border border-stone-900 text-stone-900 hover:bg-stone-900 hover:text-white transition-all" style={{ fontFamily: "'Outfit', sans-serif" }}>
                    Explore Collection
                  </Link>
                </div>
              </div>
              <div className="h-64 md:h-auto" style={{ background: `linear-gradient(135deg, ${accent}33, ${accent}55)` }}>
                {banners.length > 1 && (
                  <img src={banners[1].image_url} alt="" className="w-full h-full object-cover" />
                )}
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white border-t border-stone-100">
          <div className="max-w-xl mx-auto px-6 text-center">
            ...
            <p className="text-sm text-stone-400 mb-8" style={{ fontFamily: "'Outfit', sans-serif" }}>
            ...
            <div className="flex gap-3">
              ...
              <button className="px-8 py-3 text-xs tracking-[0.15em] uppercase text-white transition-all hover:opacity-90" style={{ fontFamily: "'Outfit', sans-serif", backgroundColor: accent }}>
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              {categories.slice(0, 4).map((cat: any) => (
                <p key={cat.id} className="text-xs text-stone-400 mb-2 hover:text-stone-700 cursor-pointer transition-colors">{cat.name}</p>
              ))}
            </div>
            <div>
              ...
              <p className="text-xs text-stone-400 mb-2">FAQs</p>
            </div>
            <div>
  ...
  return (
    <Link href={`/products/${product.id}`} className="group block">
      <div className="relative overflow-hidden mb-4" style={{ aspectRatio: "3/4", backgroundColor: "#F0EBE3" }}>
        <img
          src={img?.image_url || "https://placehold.co/600x800/F0EBE3/8B6F4E?text=" + encodeURIComponent(product.name)}
          alt={product.name}
        ...
        <div className="absolute bottom-0 left-0 right-0 translate-y-full group-hover:translate-y-0 transition-transform duration-500">
          <div className="mx-3 mb-3 py-2.5 text-center text-xs tracking-[0.15em] uppercase bg-white/95 backdrop-blur-sm text-stone-900" style={{ fontFamily: "'Outfit', sans-serif" }}>
            Quick View
          </div>
        </div>
        {/* Badges */}
        {product.is_new && (
          <span className="absolute top-3 left-3 text-[10px] tracking-[0.2em] uppercase px-2.5 py-1 bg-white text-stone-900" style={{ fontFamily: "'Outfit', sans-serif" }}>
            New
          </span>
        )}
        {hasDisc && (
          <span className="absolute top-3 right-3 text-[10px] tracking-[0.2em] uppercase px-2.5 py-1 text-white" style={{ fontFamily: "'Outfit', sans-serif", backgroundColor: accent }}>
            {v.discount_type === 1 ? `${v.discount}% Off` : `₹${v.discount} Off`}
          </span>
        )}
      </div>
      {/* Info */}
      <div>
        <p className="text-[11px] tracking-[0.1em] uppercase text-stone-400 mb-1" style={{ fontFamily: "'Outfit', sans-serif" }}>
          {product.brand}
        </p>
        <h3 className="text-base font-normal text-stone-800 mb-2 leading-snug tracking-wide">
          {product.name}
        </h3>
        <div className="flex items-center gap-2" style={{ fontFamily: "'Outfit', sans-serif" }}>
          ...
          {hasDisc && (
            <span className="text-xs text-stone-400 line-through">{fmt(v.price)}</span>
          )}
        </div>
        {/* Size hints */}
        {product.product_variants && product.product_variants.length > 1 && (
          <div className="flex gap-1.5 mt-2">
            {product.product_variants.slice(0, 4).map((variant: any, i: number) => (
              <span key={i} className="text-[10px] text-stone-400 border border-stone-200 px-1.5 py-0.5" style={{ fontFamily: "'Outfit', sans-serif" }}>
                {variant.size}
              </span>
            ))}
          </div>
